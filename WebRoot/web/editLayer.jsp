...
log(id+","+code+","+pcode+","+name+","+type+","+iconurl);
if(id==null){
	id = "";
}
if(type==null){
  ...
  <body>
  	<div class="easyui-panel" fit="true" style="padding:10px;overflow:hidden;">
		<form class="layui-form" action="">
			...
			<input type="hidden" id="iconurl" name="iconurl" value="<%=iconurl%>"/>
			<div class="layui-form-item">
				<label class="layui-form-label">图层名称</label>
				<div class="layui-input-block">
					<input type="text" name="name" id="name" required lay-verify="required"
						placeholder="请输入图层名称" autocomplete="off" class="layui-input" value="<%=name%>">
				</div>
			</div>
			<div class="layui-form-item">
