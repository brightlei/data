...
.ulcss li{display:inline-block;margin:3px;}
    ...
    $(function(){  
        $("#uploadify").uploadify({      
            ...
            'uploader': 'json/Upload!importLinePointExcel',//请求路径    
  ...
  <body style="padding:5px;overflow:hidden;">
  	<ul class="ulcss">
  		<li><a class="easyui-linkbutton" iconCls="icon-hamburg-down" style="height:28px;" href="upload/template/铁路线坐标点模板.xls">模板下载</a></li>
