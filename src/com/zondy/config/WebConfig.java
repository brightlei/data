...
public class WebConfig {
	...
	private static String configXmlPath = ApplicationListener.rootPath+"WEB-INF/resources/xml/webconfig.xml";;
	/**
	 * 功能描述：读取系统页面配置文件<br>
	 * 创建作者：雷志强<br>
...
//		tesRemoveConfig();
	...
	public static void testSaveAttConfig(){
		...
		nodeInfo.put("datetime", DateUtil.date2String("yyyy-MM-dd HH:mm:ss"));
	...
	public static void testGetConfig(){
		WebConfig wc = new WebConfig();
		String value = wc.getConfig("uploadForld");
