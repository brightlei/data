...
public class Dom4jUtils {
	...
	public static HashMap<String, String> getNodeAttrMap(Element node) {
		HashMap<String, String> nodeAttr = new LinkedHashMap<String, String>();
		List<?> attrs = node.attributes();
		int attLength = attrs.size();
		DefaultAttribute attr = null;
		for (int j = 0; j < attLength; j++) {
	...
	public static void testCreateXml(){
		...
		test.addAttribute("datetime", DateUtil.date2String("yyyy-MM-dd HH:mm:ss"));
