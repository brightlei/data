...
/**
 * 模块名称：ReadExcelUtil									<br>
 * 功能描述：该文件详细功能描述							<br>
 * 文档作者：雷志强									<br>
 * 创建时间：Mar 6, 2017 2:11:37 PM					<br>
 * 初始版本：V1.0	最初版本号							<br>
 * 修改记录：											<br>
 * *************************************************<br>
 * 修改人：雷志强										<br>
 * 修改时间：Mar 6, 2017 2:11:37 PM					<br>
 * 修改内容：											<br>
 * *************************************************<br>
 */
import java.io.File;  
...
public class ReadExcelUtil {  
  ...
  public static void main(String[] args) throws IOException {  
      ...
      String src_xlspath = "h:/tanny/避雷塔汇总.xls";  
      ...
      System.out.println("序号 | 所在区域 | 街道 | 村组 | 安装时间 ");
      ...
      eu.writeExcel(rowList, "h:/tanny/11.xls");
  }  
}  
