...
public class HttpRequest {
	...
	public static void testSendGet() throws HttpException, IOException{
...
//		//String result = new String(method.getResponseBody(),"ISO-8859-1");
//		String result = method.getResponseBodyAsString();
//		String content = new String(result.getBytes("ISO-8859-1"),"GBK");
//		content = new String(content.getBytes("GBK"),"UTF-8");
		String result = sendGetRequest(url,"UTF-8");
