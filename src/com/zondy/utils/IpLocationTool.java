...
public class IpLocationTool {
	private static String IP_FILE = ApplicationListener.rootPath+"resources/qqwry.dat"; // 纯真IP数据库名
	...
	static {
		try {
			...
			File qqWryDataFile = new File(IP_FILE);
			ipFile = new RandomAccessFile(qqWryDataFile, "r");
			ipBegin = readLong4(0);
			ipEnd = readLong4(4);
		} catch (Exception e) {
...
//		ips.add("116.113.134.96");
		...
		//ips.add("192.168.84.160");
		ips.add("180.153.214.178");
		for (String ip : ips) {
